    ...
    <>
      ...
      <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/30">
        ...
        <div className="absolute inset-0 flex items-center justify-center z-50">
          <div className="bg-white/80 border border-blue-200 shadow-2xl rounded-3xl p-12 md:p-20 flex flex-col items-center backdrop-blur-xl">
            <span
              className="text-6xl md:text-8xl font-extrabold tracking-tight mb-6 bg-gradient-to-r from-blue-600 via-blue-500 to-purple-600 bg-clip-text text-transparent drop-shadow-lg"
              style={{ letterSpacing: '0.05em' }}
            >
              Coming Soon
            </span>
            <span className="text-2xl md:text-3xl text-gray-700 font-medium text-center max-w-xl">
              The TangibleFi Community is launching soon!
            </span>
          </div>
        </div>
      </div>
