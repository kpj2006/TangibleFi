      ...
      if (response.ok) {
        ...
        setAutomationRules([
          ...
          },
          {
            ...
            lastExecuted: "2024-01-08T09:00:00Z",
            executionCount: 3,
            successRate: 100,
            createdAt: "2024-01-01T00:00:00Z",
            createdBy: "0x742d35Cc6634C0532925a3b8D4C9db96590c6C8b",
          },
          {
            ...
            lastExecuted: "2024-01-15T15:00:00Z",
            executionCount: 360,
            successRate: 99.2,
            createdAt: "2024-01-01T00:00:00Z",
            createdBy: "0x742d35Cc6634C0532925a3b8D4C9db96590c6C8b",
      ...
      {isCreating && (
        <Card className="border-blue-200 bg-blue-50">
          <CardHeader>
            ...
            <CardDescription>Configure a new automated process</CardDescription>
          </CardHeader>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="approve_asset">Approve Asset</SelectItem>
            ...
            {newRule.type === "scheduled" && (
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewRule({ ...newRule, triggerSchedule: e.target.value })
                  }
